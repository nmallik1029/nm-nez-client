 ...
 *
 * Styled from the shared --nm-game-* group so it reads as part of the client
 * (see shared/ui/sheets.ts), and the whole thing is textContent and
 * createElement, no innerHTML, same as every other overlay here.
 */

const ID = UI_IDS.update;
